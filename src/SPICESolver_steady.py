...
class SPICE_steadySolver:
    ...
    def getTemperature(self,dict_properties, logFile=None,SpiceFile=None,SpiceResultFile=None,mode=None):
        ...
        with open(SpiceFile,'w') as myfile:
                ...
                myfile.write('.OP\n')
                #disable zoltan (uncomment first 2, comment 3rd) for mono3D simulation?
                #Xyce provides hypergraph partitioning via the Zoltan library of parallel partitioning heuristics integrated into Xyce.
